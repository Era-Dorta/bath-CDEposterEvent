...
\headerbox{Performance-driven Facial Animation}{name=conclusion,column=2,span=1,row=0}{
...
\headerbox{Skin Rendering}{name=skinRendering,column=0,below=objectives}{ % This block's bottom aligns with the bottom of the conclusion block
\begin{center}
...
\end{center}
	...
	A high-resolution bump map $B'$ can be synthesized from a lower resolution $B$ and a pair of training samples $A$ and $A'$.
}
