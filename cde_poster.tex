...
\begin{equation*}
\begin{aligned}
\mathbf{E} &= f(\boldsymbol\theta) \rightarrow \boldsymbol{\theta} = f^{-1}(\mathbf{E}) \\  \partial \mathbf{E} &\approx J(\boldsymbol\theta) \partial \boldsymbol\theta \rightarrow \partial \boldsymbol{\theta} \approx J^{+}(\partial\mathbf{E}),
\end{aligned}
\end{equation*}
...
\captionof{figure}{SIFT feature matching.}
\end{center}
