...
\headerbox{Shape Interpolation}{name=method,column=1,below=introduction}{%,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{3D Reconstruction}{name=results2,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
