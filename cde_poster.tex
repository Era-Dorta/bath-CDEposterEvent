...
\end{aligned}
\end{equation*}
where $f$ is the forward kinematics solver and $J$ is the Jacobian matrix, and $J^+ = (J^T J)^{-1}J^T$ is the pseudoinverse of $J$.
...
\headerbox{Gaussian Process}{name=introduction,column=1,row=0,span=1}{
...
\begin{center}
\includegraphics[height=4cm]{facecapture}
\includegraphics[height=4cm]{face3d}
\captionof{figure}{Linkage simulation with trace.}
\end{center}
