...
\headerbox{SIFT Features}{name=results,column=2,span=2,row=0}{
...
\item[Garoe] g.dorta.perez@bath.ac.uk 
\item[Ieva] ik359@bath.ac.uk 
\item[Richard] richard.o.shaw@gmail.com
\end{description}
}
...
\headerbox{Visual Understanding 2}{name=conclusion,column=2,span=2,row=0,below=results,above=references}{
